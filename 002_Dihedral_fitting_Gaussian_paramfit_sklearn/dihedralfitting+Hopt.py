...
def check_clashes(torsion_name, conf ,cutoffnonh=0.210 ,cutoffoneh=0.140 ,cutoffoxy=0.140 ,cutofftwoh=0.100) :
    bonds=[]
...
if __name__ =='__main__':
        ...
        for torsion in range(len(torsion_names)):
            if  torsion_names[torsion]!=False:
                ...
                #print(data)
                result ,inputfct=leastsquare_with_prem(x.T,derivdata, all_dihedrals_type_index[torsion],all_dihedrals_type[torsion], maxorder)
                ...
                plot( derivdata, derivdata+result.residual,xvalues, outputfile=torsion_names[torsion]+'fittingresiduals.png' )
